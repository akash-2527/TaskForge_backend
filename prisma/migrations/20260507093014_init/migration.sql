...
-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('TASK_CREATED', 'TASK_UPDATED', 'TASK_DELETED', 'STATUS_CHANGED', 'ASSIGNMENT_CHANGED', 'MEMBER_ADDED', 'MEMBER_REMOVED', 'PROJECT_UPDATED', 'PROJECT_CREATED');
...
-- CreateIndex
CREATE INDEX "tasks_project_id_assigned_to_idx" ON "tasks"("project_id", "assigned_to");

-- CreateIndex
CREATE INDEX "tasks_due_date_idx" ON "tasks"("due_date");

-- CreateIndex
CREATE INDEX "tasks_project_id_is_deleted_idx" ON "tasks"("project_id", "is_deleted");
